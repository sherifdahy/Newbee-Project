        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "D5CD1328-D599-4608-B5B0-C00056B6E7D7", false, false, "Client", "CLIENT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "A999212D-E3FE-410C-BEA5-888AD868482C", "admin@newbee.com", true, "", false, false, false, null, "", "ADMIN@NEWBEE.COM", "ADMIN@NEWBEE.COM", "AQAAAAIAAYagAAAAEP4fDNXOvbqiMtqmM1dk3P9w5XYY+YFIqHpyYibcKD0g8p9PWztiJdeO3FnvT2iWgg==", null, false, "3F52186E-A158-4F4A-8822-ABEE912135EB", false, "admin@newbee.com" },
                    { 2, 0, "A6A25E9C-4768-4F1C-87F6-2D5E1CE80252", "Manager@newbee.com", true, "", false, false, false, null, "", "MANAGER@NEWBEE.COM", "MANAGER@NEWBEE.COM", "AQAAAAIAAYagAAAAEP4MEBpa+QdPoQyCkNll+BpOxUGhpnM86iPjXhZlxuUQVgrZpvj4VEpgqY3EULEPpQ==", null, false, "9B7F1E11-13B3-4FF7-95CB-49F4B81486EE", false, "Manager@newbee.com" },
                    { 3, 0, "F8F79F8F-BBAE-47BD-BF9D-BDFA8BE91136", "client@newbee.com", true, "", false, false, false, null, "", "CLIENT@NEWBEE.COM", "CLIENT@NEWBEE.COM", "AQAAAAIAAYagAAAAEExiooVcrWxkmmekY488OU8Ltn1JxixL1D2X8oJuxxBJUfKHI9Ee+jVgg+eifh9LEw==", null, false, "B770584C-684A-40C4-87E3-BC175BC23550", false, "client@newbee.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 26, "permissions", "companies:read", 1 },
                    { 27, "permissions", "companies:create", 1 },
                    { 28, "permissions", "companies:update", 1 },
                    { 29, "permissions", "companies:toggleStatus", 1 },
                    { 30, "permissions", "products:read", 1 },
                    { 31, "permissions", "products:create", 1 },
                    { 32, "permissions", "products:update", 1 },
                    { 33, "permissions", "products:toggleStatus", 1 },
                    { 34, "permissions", "categories:read", 1 },
                    { 35, "permissions", "categories:create", 1 },
                    { 36, "permissions", "categories:update", 1 },
                    { 37, "permissions", "categories:toggleStatus", 1 }
                });
